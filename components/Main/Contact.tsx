...
export const Contact = () => {
  ...
  return (
    <div className="w-full max-w-5xl h-[40rem] lg:h-[45rem] mx-auto relative flex justify-center items-center ">
      ...
      <div className="absolute bottom-0 z-30 flex flex-col lg:flex-row gap-8 justify-between items-center w-full pb-8">
        <span className="text-sm tracking-wider">Copyright ©2025 Oğuzhan Dağ</span>
        <div className="flex items-center gap-4">
          <span className="flex items-center border border-white/10 shadow-xs shadow-white/20  justify-center w-10 h-10 bg-[#05041F] rounded-lg text-white">
            <SiInstagram />
          </span>
          <span className="flex items-center border border-white/10 shadow-xs shadow-white/20  justify-center w-10 h-10 bg-[#05041F] rounded-lg text-white">
            <SiX />
          ...
          <a
            ...
            target="_blank"
            className="flex items-center border border-white/10 shadow-xs shadow-white/20  justify-center w-10 h-10 bg-[#05041F] rounded-lg text-white"
          >
            <SiGithub />
          </a>
          <span className="flex items-center border border-white/10 shadow-xs shadow-white/20  justify-center w-10 h-10 bg-[#05041F] rounded-lg text-white">
